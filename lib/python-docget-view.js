...
export default class PythonDocgetView {
  ...
  constructor(serializedState) {
    ...
    // I might want a disposable or something here
    this.searchButton.addEventListener('click',event => {this.search(this.searchEditor.getText());})
    this.searchEditor.getElement().addEventListener('keydown',event => {
  ...
  search(searchterm) {
    this.clearElement()
    this.searchEditor.setText(searchterm)
